...
interface JellyfinRepository {
    ...
    suspend fun getItems(
        ...
        startIndex: Int? = null,
        limit: Int? = null,
        genreIds: List<String>? = null,    // Filter parameter (UUIDs)
        years: List<Int>? = null           // Filter parameter
    ): List<FindroidItem>
    ...
    suspend fun getGenres(parentId: UUID?): List<Pair<String, String>> // Thêm phương thức lấy thể loại
}